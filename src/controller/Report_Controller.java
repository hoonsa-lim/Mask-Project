...
public class Report_Controller implements Initializable {
	...
	// 멤버 변수
	public Stage reportStage;// 업체관리 stage
	...
	private void tableViewColumnInit() {
		...
		tableView.getColumns().addAll(colDate, colCompany, colProductName, colProductNum, colQuantity, colPrice);
	}
	...
	private void tableViewtradeListInit(String purchaseOrSell) {
		...
		if (arrayList.size() != 0) {
			...
			tableView.setItems(obsListTrade);
		} else {
